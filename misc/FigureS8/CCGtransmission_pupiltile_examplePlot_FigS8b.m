...
plot([0,0],[0,70],'k--')
xlim([-0.05,0.05])
%% plot ACG from cell metrics
figure
acg_time =  -100:100; % time axis (in ms)
plot(acg_time,cell_metrics.acg.narrow(:,160))
hold on
plot(acg_time,cell_metrics.acg.narrow(:,24))
