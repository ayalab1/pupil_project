...
for session_list = 1:length(animal_info)
    ...
    LFP_features_trans = LFP_features_all';
    ...
    if savedata
        save(fullfile(animaldir,[prefix,'.rawStructureIndex-ALLStatesN20','.mat']),'LFP_features','pupil_label','Structure_index','shuf_SI_vals');
    end
    close all
end
