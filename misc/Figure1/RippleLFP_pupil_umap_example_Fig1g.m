...
% ripple_umap = run_umap(lfp_ripples,'min_dist',0.6,'n_neighbors',100,'metric','cosine','n_components',3,'save_template_file','PPP4_D8E3_rippleLFP_UMAP3.mat');

% use the template for replicability
ripple_umap = run_umap(lfp_ripples,'min_dist',0.6,'n_neighbors',100,'metric','cosine','n_components',3,'template_file','PPP4_D8E3_rippleLFP_UMAP3.mat');
%% plot results
