% this is the preprocessing step to generate Fig. 1h - gathering ripple LFP
% across all sleep states for further calculating SI
clc
clear all
close all
%% define data
...
%% define parameters
savedata = 1;
mindur = 10; % minimal NREM duration, in sec
...
for session_list = 1:length(animal_info)
    ...
    % Read in xml of file parameters, LoadXml.m and from getLFP.m from AYALab neurocode
    ...
    % filter LFP to ripple band, bz_Filter.m and eventLFP.m from AYALab neurocode
