% this is the main script to calculate path length in the cheeseboard task
clc
clear all
close all
%% define data
dir = '/Volumes/Pupil_data/Pupil_OptoBehav/';
...
max_posdiff = 5; % max jumping distance
bin = 0.02; % 20 ms
%% load behavior info
...
for tr = 1:traintrial_num
    ...
    behavior.train_pathlength = pathlength; % in pixel
end

%% probe and test trials
fig = figure;
plot_number = 0;
...
for tr = 1:testtrial_num
    ...
    behavior.test_pathlength = pathlength; % in pixel
end
%%
