% this is the main script to calculate reactivation strength of rigid 
% (pre-existing; PRE) versus Plastic (PLA) cell assemblies
...
if savedata
    save(sprintf('%s/%sReactivationStrength_all_preexisting.mat', dir, prefix), 'strength_preexisting','strength_plastic');
end
