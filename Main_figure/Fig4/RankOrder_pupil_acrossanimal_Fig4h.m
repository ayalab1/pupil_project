% this is the main script to generate Fig. 4h
clc
clear all
close all
...
% list of all data, [animal, day, POST epoch]
% only post-experience sessions are used
animal_info = [{'PPP4'},{8},{3};...
    ...
    {'PPP8'},{8},{3}];
%% define parameters
win = -30:0.1:30; % window around ripples, in sec
...
for session_list = 1:length(animal_info)
    ...
    for tile = 1:6
        ...
        spikes_ripples = getRipSpikes(spikes,riplist_all,'basepath',animaldir,'saveMat',false); % getRipSpikes.m from AYALab neurocode
